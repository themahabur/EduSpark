    ...
    <div className="flex justify-between items-center p-4 container mx-auto sticky top-0 z-10 bg-base-100">
      <div className="relative flex justify-center items-center gap-2 md:block">
        <div className="md:hidden ">
          {
            isMenuOpen?  <IoClose   size={24} onClick={handleMenuToggle} />:<IoMenu size={24} onClick={handleMenuToggle} />
          }
      ...
      <div className="flex justify-center items-center gap-4">
        {user ? (
          <div className="relative cursor-pointer">
            <div className="rounded-full w-10 h-10 overflow-hidden relative" onClick={() => setIsProfileMenuOpen(!isProfileMenuOpen)}>
